...
/* Fixed clean reclaim-ahead until bio/VMA stream detection lands. */
#define NAMED_SWAP_RECLAIM_AHEAD	512
#define NAMED_SWAP_RECLAIM_GO_BACK	256

/*
 * Why a clean named_swap reclaim xarray walk stopped (or why a step
 * is not sequential). Used to blame reclaim vs flusher vs RA holes.
 */
enum named_swap_seq_stop {
	NAMED_SWAP_SEQ_OK,
	NAMED_SWAP_SEQ_WINDOW_FULL,
	NAMED_SWAP_SEQ_NO_ENTRY,
	NAMED_SWAP_SEQ_VALUE_ENTRY,
	NAMED_SWAP_SEQ_INDEX_GAP,
	NAMED_SWAP_SEQ_DIRTY,
	NAMED_SWAP_SEQ_WRITEBACK,
	NAMED_SWAP_SEQ_WRONG_GEN,
	NAMED_SWAP_SEQ_WRONG_ZONE,
	NAMED_SWAP_SEQ_WRONG_TYPE,
	NAMED_SWAP_SEQ_WRONG_LRUVEC,
	NAMED_SWAP_SEQ_NOT_LRU,
	NAMED_SWAP_SEQ_UNEVICTABLE,
	NAMED_SWAP_SEQ_ACTIVE,
	NAMED_SWAP_SEQ_SORT,
	NAMED_SWAP_SEQ_ISOLATE_FAIL,
	NAMED_SWAP_SEQ_GO_BACK_LIMIT,
	NAMED_SWAP_SEQ_MAPPING_GONE,
};

/*
 * Outcome of shrink_folio_list() for a named_swap folio. Distinguishes
 * "isolated for reclaim" from "actually deleted from page cache".
 */
enum named_swap_reclaim_result {
	NAMED_SWAP_RECLAIM_FREED,
	NAMED_SWAP_RECLAIM_FREED_RACE,
	NAMED_SWAP_RECLAIM_KEEP_LOCK,
	NAMED_SWAP_RECLAIM_KEEP_MAPPED,
	NAMED_SWAP_RECLAIM_KEEP_REFERENCED,
	NAMED_SWAP_RECLAIM_KEEP_DIRTY,
	NAMED_SWAP_RECLAIM_KEEP_PAGEOUT,
	NAMED_SWAP_RECLAIM_KEEP_WRITEBACK,
	NAMED_SWAP_RECLAIM_KEEP_MAPPING,
	NAMED_SWAP_RECLAIM_KEEP_OTHER,
	NAMED_SWAP_RECLAIM_ACTIVATE_UNEVICTABLE,
	NAMED_SWAP_RECLAIM_ACTIVATE_WRITEBACK,
	NAMED_SWAP_RECLAIM_ACTIVATE_REFERENCED,
	NAMED_SWAP_RECLAIM_ACTIVATE_UNMAP_FAIL,
	NAMED_SWAP_RECLAIM_ACTIVATE_PINNED,
	NAMED_SWAP_RECLAIM_ACTIVATE_DIRTY,
	NAMED_SWAP_RECLAIM_ACTIVATE_PAGEOUT,
	NAMED_SWAP_RECLAIM_ACTIVATE_BUFFERS,
	NAMED_SWAP_RECLAIM_ACTIVATE_SWAP,
	NAMED_SWAP_RECLAIM_ACTIVATE_OTHER,
	NAMED_SWAP_RECLAIM_WAIT_WRITEBACK,
